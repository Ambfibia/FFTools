...
Если TTF-шрифты настроены, патчер растеризует из них основной печатный ASCII-набор
(буквы, цифры, пунктуацию) и русские глифы в соответствующие Unity bitmap font atlases.
Также добавляются CP1251 byte-code aliases для русских input fields старого Unity GUI.
Остальные существующие глифы сохраняются.
